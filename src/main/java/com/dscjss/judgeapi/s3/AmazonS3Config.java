...
public class AmazonS3Config {
    ...
    @Value("${amazonProperties.submissionDetailsBucket}")
    private String submissionDetailsBucket;
    ...
    public String getSubmissionDetailsBucket() {
        return submissionDetailsBucket;
    }
    ...
    public TransferManager transferManager() {
        ...
        try {
            ...
            tm.abortMultipartUploads(submissionDetailsBucket, oneDayAgo);
